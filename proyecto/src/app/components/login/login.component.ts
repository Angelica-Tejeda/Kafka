   ...
   ngOnInit(): void {
      $(function () {
         ...
         boton.click(function (e: any) {
            var pX = e.pageX,
               pY = e.pageY,
               oX = parseInt(boton.offset().left),
               oY = parseInt(boton.offset().top);

            boton.append('<span class="click-efect x-' + oX + ' y-' + oY + '" style="margin-left:' + (pX - oX) + 'px;margin-top:' + (pY - oY) + 'px;"></span>')
            $('.x-' + oX + '.y-' + oY + '').animate({
               "width": "500px",
               "height": "500px",
               "top": "-250px",
